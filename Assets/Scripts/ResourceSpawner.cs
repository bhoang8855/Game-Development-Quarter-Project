...
public class ResourceSpawner : MonoBehaviour
{
	...
	public float spawnRate = 2.0f;		//change in inspector
	...
	void Update ()
	{
		if (phaseSystemRef.gatherPhase && spawnCount < MAX_SPAWN_COUNT && Time.time > nextSpawn)
		{
			...
			do {
				...
				whereToSpawn = new Vector2 (Random.Range(-11.5f,19.0f), Random.Range(-18.0f, 11.5f));		//these are the play area bounds
